...
function TopMenu({ displayClass, fileData }: QuartzComponentProps) {
  const tags: string[] = (fileData?.frontmatter?.tags ?? []).map((t: unknown) => String(t).toLowerCase())
  ...
  return (
    <nav class={classNames(displayClass, "top-menu")} aria-label="Top Menu">
      {hasPersonal ? <a href="/tags/personal" class="internal tag-link">personal</a> : "#personal"}
      <span aria-hidden="true" style="margin: 0 0.5rem;">|</span>
      {hasWork ? <a href="/tags/work" class="internal tag-link">work</a> : "#work"}
    </nav>
  )
}
